    ...
    <div class="min-h-screen flex bg-surface-deep">
      ...
      <div class="hidden lg:flex lg:w-1/2 bg-dark-gradient items-center justify-center p-12 relative overflow-hidden">
        <div class="absolute inset-0 opacity-10">
          <div class="absolute top-20 right-20 w-80 h-80 bg-primary rounded-full blur-[120px]"></div>
          <div class="absolute bottom-10 left-10 w-64 h-64 bg-accent-gold rounded-full blur-[130px]"></div>
        </div>
        <div class="relative z-10 max-w-md text-center">
          ...
          <p class="text-text-secondary text-lg leading-relaxed">
            Start tracking your movies and shows today. Build your watchlist, rate titles, and explore.
          </p>
        </div>
      </div>
